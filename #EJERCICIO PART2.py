#EJERCICIO MINI PROGRAMA
#FUNCIONES:
#MENU PRINCIPAL (DA PASO A LOS DOS SUBMENUS)
#MENÚ PRINCIPAL
def menu_principal(articulos, usuarios):
    opcion = 0
    ...
    while opcion != 3:
        ...
        if opcion == 1:
            menu_articulos(articulos)  #Submenú de artículos
        elif opcion == 2:
            menu_usuarios(usuarios)    #Submenú de usuarios
        elif opcion == 3:
...
articulos = []
usuarios = []
menu_principal(articulos, usuarios) #Punto de entrada principal del programa